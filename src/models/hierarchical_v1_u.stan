...
parameters {
  ...
  real<lower=-100, upper=100> mu_alpha;               // mean intercept across species
  real<lower=-100, upper=100> mu_beta_depth;          // mean bill depth effect across species
  real<lower=0, upper=100> sigma_alpha;   // variation in intercepts across species
  real<lower=0, upper=100> sigma_beta;    // variation in slopes across species
  ...
  // Observation level
  real<lower=-100, upper=100> beta_sex;               // sex effect (pooled across species)
